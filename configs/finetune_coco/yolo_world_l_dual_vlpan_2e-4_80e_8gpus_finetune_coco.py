...
# 数据集设置
text_transform = [
    dict(type='RandomLoadText',#定义字典，包含参数type。。。
         num_neg_samples=(num_classes, num_classes),
         max_num_samples=num_training_classes,
         padding_to_max=True,
         padding_value=''),
    dict(type='mmdet.PackDetInputs',# 定义一个字典，包含参数 type 和 meta_keys
...
train_pipeline_stage2 = [# 定义第二阶段训练数据处理流程的列表
