...
class YOLOWorldPAFPN(YOLOv8PAFPN):
    # 基于 YOLOv8 的路径聚合特征金字塔网络(Path Aggregation Network, PAFPN) 的扩展版本，特别支持文本到图像的特征融合，以处理多模态任务。
...
@MODELS.register_module() #引入了 text_enhancer 模块，在 Bottom-Up 路径中使用增强后的文本特征，进一步提升了文本与图像特征的交互
